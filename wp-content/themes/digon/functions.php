...
// Notifier Info
$notifier_name = "Digon";
$notifier_url = "http://www.imaginemthemes.com/notifier/digon/notifier.xml";
// Theme name in short
$shortname = "mtheme_p2";
...
if ( ! isset( $content_width ) ) { $content_width = 592; }
...
/* Load Admin */
/*-------------------------------------------------------------------------*/
	require_once (MTHEME_PARENTDIR . '/framework/admin/admin_setup.php');
/*-------------------------------------------------------------------------*/
/* Core Libraries */
/*-------------------------------------------------------------------------*/
...
function load_theme_shortcodes() {
	...
	require_once (MTHEME_SHORTCODES . 'audio.php');
	}
...
function load_theme_shortcodegens() {
	...
	require_once (MTHEME_SHORTCODEGENS . 'audio/tinymce.php');
	require_once (MTHEME_SHORTCODEGENS . 'gmaps/tinymce.php');
}
/*-------------------------------------------------------------------------*/
/* Load Widgets */
/*-------------------------------------------------------------------------*/
